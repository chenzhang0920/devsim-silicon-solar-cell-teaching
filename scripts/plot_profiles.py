...
def main() -> None:
    ...
    ax.semilogy(x_um, acceptors, color=C_ORANGE, label=r"Acceptors $N_{\mathrm{A}}$")
    ax.semilogy(x_um, donors, color=C_BLUE, label=r"Donors $N_{\mathrm{D}}$")
    ...
    _style(
        ...
        xlabel=r"Depth $x$ ($\mu\mathrm{m}$) — junction zoom",
        ylabel=r"Doping ($\mathrm{cm^{-3}}$)",
    )
    ...
    _style(
        ...
        xlabel=r"Depth $x$ ($\mu\mathrm{m}$) — junction zoom",
        ylabel=r"Electric field $E$ ($\mathrm{kV\,cm^{-1}}$)",
    )
    ...
    _style(
        ...
        xlabel=r"Depth $x$ ($\mu\mathrm{m}$) — full device",
        ylabel=r"Carrier density ($\mathrm{cm^{-3}}$)",
    )
    ...
    _style(
        ...
        xlabel=r"Depth $x$ ($\mu\mathrm{m}$) — full device",
        ylabel=r"Generation $G$ ($\mathrm{cm^{-3}\,s^{-1}}$)",
    )
